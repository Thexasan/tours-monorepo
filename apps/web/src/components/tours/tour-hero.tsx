      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-24 md:pb-28">
        <div className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8">
          <nav className="flex items-center gap-1.5 text-xs text-white/70 mb-5">
            ...
            <a href={`/${locale}/tours`} className="hover:text-white transition-colors">Туры</a>
            <ChevronRight className="h-3 w-3" />
          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            {isHot && (
              ...
              >
                ...
                Горящий тур{discount > 0 ? ` · −${discount}%` : ""}
              </span>
            )}
            ...
            {reviewsCount > 0 && (
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/15 text-white text-[11px] font-bold backdrop-blur ring-1 ring-white/25">
                ...
                {avgRating.toFixed(2)} · {reviewsCount} отзывов
              </span>
            )}
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-end gap-x-8 gap-y-4">
            <div className="text-white">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-white/60 mb-1">от</p>
              ...
              <p className="text-xs text-white/70 mt-1">за человека · все налоги включены</p>
            </div>
